...
class cHoster(iHoster):
    ...
    def __init__(self):
        #Nom a afficher dans Adult Stream
    ...
    #Fonction appelle par Adult Stream pour avoir le lien decode
...
#Attention : Pour fonctionner le nouvel hebergeur doit etre rajoute dans le corps de Adult Stream, fichier Hosters.py.
#----------------------------------------------------------------------------------------------------------------
#
