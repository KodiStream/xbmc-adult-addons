...
class cGuiElement:
    ...
    def __init__(self):
        ...
        self.__sRootArt = 'special://home/addons/plugin.video.adult.stream/resources/art/'
        self.__sType = 'Video'
        self.__sMeta = 0
        self.__sPlaycount = 0
        ...
        self.__sFanart = "special://home/addons/plugin.video.adult.stream/fanart.jpg"
        ...
        #1 - straight movies , 2 - shemale movies, - 3 gay movies,
    ...
    def setAebn(self, sAebnId):
        self.__TvtsvodId = sTvtsvodId
    def getAebn(self):
        return self.__sAebn
    ...
    def setAebnId(self, data):
        self.__AebnId = data
    def getAebnId(self):
        return self.__AebnId
    ...
    def getIcon(self):
        ...
        folder = "special://home/addons/plugin.video.adult.stream/resources/art"
    ...
    def getMetadonne(self):
        ...
        sType = '1'
        sType = str(self.getMeta()).replace('1', 'pornmovie').replace('2', 'transmovie').replace('3', 'gaymovie')
             
        if (sType == 'pornmovie' or sType == 'transmovie' or sType == 'gaymovie'):
            from resources.lib.scrapers.main import cDEFAULT
            grab = cDEFAULT()
            args = (sType, self.__sFileName)
            kwargs = {}
            if (self.__AebnId):
                kwargs['Aebn_id'] = self.__AebnId
            if (self.__Year):
    ...
    def getItemValues(self):
        ...
        if self.getAebnId():
            self.addItemProperties('AebnId', str(self.getAebnId()))         
