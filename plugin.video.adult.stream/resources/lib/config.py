...
class GestionCookie():
    #PathCache = xbmc.translatePath(xbmcaddon.Addon('plugin.video.adult.stream').getAddonInfo("profile")).decode("utf-8")
    PathCache = "special://userdata/addon_data/plugin.video.adult.stream"
...
class cConfig():
    ...
    # def __init__(self):
        ...
        # self.__sFileDB = os.path.join(self.__oCache,'adult_stream.db').decode("utf-8")
